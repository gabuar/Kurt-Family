...
public class Patient {
    ...
    private Integer systolicBP = null; // systolic blood pressure
    private boolean seizing = false; // ongoing uncontrolled seizure
    private boolean hasMajorComorbidity = false; // e.g., HF, COPD, CKD
    private Double trendScore = 0.0; // >0 worsens, <0 improving, small magnitude
    ...
    // simple getters and setters (same API as before)
    ...
    // optional vitals/trend getters and setters
